...
const PremiumBanner: React.FC = () => {
  ...
  return (
    <>
      <div className="relative overflow-hidden bg-gradient-to-r from-green-600 via-emerald-600 to-green-600 rounded-2xl p-8 text-white mb-8 shadow-xl">
        <div className="absolute inset-0 bg-gradient-to-r from-green-600/50 to-emerald-600/50">
        ...
        <div className="relative">
          <div className="flex items-start justify-between mb-8">
            ...
            <div className="text-right">
              ...
              <div className="text-green-200 text-sm">Cancel anytime</div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 transform hover:scale-105 transition-transform">
              ...
              <p className="text-green-100 text-sm">Get personalized recipe suggestions and cooking tips from our AI chef</p>
            </div>

            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 transform hover:scale-105 transition-transform">
              <Calendar className="w-6 h-6 text-amber-300 mb-2" />
              <h4 className="font-semibold mb-2">Smart Meal Planning</h4>
              <p className="text-green-100 text-sm">Generate weekly meal plans with automatic shopping lists</p>
            </div>

            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 transform hover:scale-105 transition-transform">
              <BookOpen className="w-6 h-6 text-amber-300 mb-2" />
              <h4 className="font-semibold mb-2">Recipe Library</h4>
              <p className="text-green-100 text-sm">Save and organize your favorite recipes with detailed instructions</p>
            </div>
          </div>
